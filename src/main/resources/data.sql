...
insert into boat_owner (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Damon", "Beasley", "random2@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, -1171707136);
insert into boat_owner (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Arden", "Dodge", "random3@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, 1326308801);
insert into boat_owner (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Jemima", "Fishman", "random4@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, -470642558);
--neodobren
insert into boat_owner (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Doug", "Leon", "random16@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, FALSE, 924836377);


insert into cottage_owner (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Clair", "Albertson", "random5@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, 2027373379);
insert into cottage_owner (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Gil", "Sumner", "random6@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, 230422020);
insert into cottage_owner (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Gus", "Clemens", "random7@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, -1566529339);
--neodobren
insert into cottage_owner (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Ted", "Osbourne", "random17@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, FALSE, -872114982);


insert into fishing_instructor (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash, start_work_period, end_work_period) values ("Meadow", "Ready", "random8@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, 931486598, "2023-01-01", "2023-01-15" );
insert into fishing_instructor (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash, start_work_period, end_work_period) values ("Topher", "Craft", "random9@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, -865464761, "2023-01-01", "2023-01-15" );
insert into fishing_instructor (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash, start_work_period, end_work_period) values ("Rickie", "Croft", "random10@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, -1178357357, "2023-01-01", "2023-01-15" );
--neodobren
insert into fishing_instructor (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash, start_work_period, end_work_period) values ("Wendell", "Wade", "random18@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, FALSE, 1625900955, "2023-01-01", "2023-01-15" );
...
insert into registered_user (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Oliver", "Brooks", "random11@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, 1319658580);
insert into registered_user (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Max", "Morris", "random12@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, -477292779);
insert into registered_user (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Rory", "Atkinson", "random13@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, 2020723158);
insert into registered_user (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Jennifer", "Wells", "random14@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, 223771799);
insert into registered_user (name, lastname, email, password, address, city, country, telephone_number, wants_deletion, authenticated, email_hash) values ("Isabel", "Poole", "random15@gmail.com", "testpassword", "Address", "City", "Country", "064121213", FALSE, TRUE, -1573179560);
