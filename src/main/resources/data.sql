...
insert into boat(owner_id ,name, type, length, engine_number, engine_power, max_speed, navigation_equipment, address, geo_lng, geo_lat, promo_description, rules, price_per_day, reservation_start, reservation_end, price_and_info, max_users, hidden, equipment)
            values(1, "Nepotopivi 2", "Yamaha", "15", 1, 321, 321, "Sonar", "Address", 44.374710, -68.191748, "VeryFastBoy", "Don't talk about Nepotopivi 1", 50, "2023-01-01", "2023-01-15", "Lorem", 7, false, "stap za pecanje");

insert into boat(owner_id ,name, type, length, engine_number, engine_power, max_speed, navigation_equipment, address, geo_lng, geo_lat, promo_description, rules, price_per_day, reservation_start, reservation_end, price_and_info, max_users, hidden, equipment)
            values(1, "Miss Melanoma", "Yamaha", "15", 1, 321, 321, "Sonar", "Address", 44.374710, -68.191748, "VeryFastBoy", "Nije lose", 50, "2023-01-01", "2023-01-15", "Lorem", 7, false, "stap za pecanje");

insert into boat(owner_id ,name, type, length, engine_number, engine_power, max_speed, navigation_equipment, address, geo_lng, geo_lat, promo_description, rules, price_per_day, reservation_start, reservation_end, price_and_info, max_users, hidden, equipment)
            values(1, "Brzi", "Yamaha", "15", 1, 321, 321, "Sonar", "Address", 44.374710, -68.191748, "VeryFastBoy", "Ipak nije tako brz", 50, "2023-01-01", "2023-01-15", "Lorem", 7, false, "stap za pecanje");

insert into boat(owner_id ,name, type, length, engine_number, engine_power, max_speed, navigation_equipment, address, geo_lng, geo_lat, promo_description, rules, price_per_day, reservation_start, reservation_end, price_and_info, max_users, hidden, equipment)
            values(1, "Just A Splash", "Yamaha", "15", 1, 321, 321, "Sonar", "Address", 44.374710, -68.191748, "VeryFastBoy", "Potopio nepotopivog1", 50, "2023-01-01", "2023-01-15", "Lorem", 7, false, "stap za pecanje");

insert into boat(owner_id ,name, type, length, engine_number, engine_power, max_speed, navigation_equipment, address, geo_lng, geo_lat, promo_description, rules, price_per_day, reservation_start, reservation_end, price_and_info, max_users, hidden, equipment)
            values(1, "Peti Sveti", "Yamaha", "15", 1, 321, 321, "Sonar", "Address", 44.374710, -68.191748, "Holie", "Ovaj jeste Sveti Peti", 50, "2023-01-01", "2023-01-15", "Lorem", 7, false, "stap za pecanje");
