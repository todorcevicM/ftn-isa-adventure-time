			...
			<div class="table">
				...
				>
					...
					<div class="entryRight">
						<button
							class="entryDeny"
							@click="cancelBooking(pbb.userNameBoatBookingDTO[0].boatBooking.id, 'BOAT')"
						>
							Cancel
						</button>
					</div>
			...
			<div class="table">
				...
				>
					<div class="entryLeft">
						...
						<p class="entryLeftShort">
							{{
								pab.userNameAdventureBookingDTO[0].adventureBooking.extraService
							}}
						</p>
					</div>
					<div class="entryRight">
						<button
							class="entryDeny"
							@click="cancelBooking(pab.userNameAdventureBookingDTO[0].adventureBooking.id, 'ADVENTURE')"
						>
							Cancel
						</button>
					</div>
			...
			<div class="table">
				...
				>
					<div class="entryLeft">
						...
						<p class="entryLeftShort">
							{{
								prb.userNameRoomBookingDTO[0].roomBooking.extraService
							}}
						</p>
					</div>
					<div class="entryRight">
						<button
							class="entryDeny"
							@click="cancelBooking(prb.userNameRoomBookingDTO[0].roomBooking.id, 'COTTAGE')"
						>
							Cancel
						</button>
					</div>
			...
			.then(function (response) {
				...
				for (let i = 0; i < size; i++) {
					...
					let newEnd =
						futureBoatBookingsDTO.value[
							i
						].userNameBoatBookingDTO[0].boatBooking.end.split(
							"T"
						);
					let newEndSecondPart = newEnd[1].split(".")[0];
			...
			.then(function (response) {
				...
				for (let i = 0; i < size; i++) {
					...
					let newEnd =
						futureRoomBookingsDTO.value[
							i
						].userNameRoomBookingDTO[0].roomBooking.end.split(
							"T"
						);
					let newEndSecondPart = newEnd[1].split(".")[0];
